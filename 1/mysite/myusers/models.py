...
class MyUser(AbstractBaseUser):
    ...
    phonenumber = models.CharField(max_length=11, unique=False,verbose_name='手机号')
    IDcard = models.CharField(max_length=18, unique=False ,verbose_name='身份证')
    ...
    QQ = models.CharField(max_length=30, unique=False,verbose_name='QQ号',default='88888888')
